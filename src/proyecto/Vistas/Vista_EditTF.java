 ...
 * @date 24 nov. 2021
 */
public class Vista_EditTF extends javax.swing.JDialog {

    /**
     * Creates new form Vista_TF
     */
    public Vista_EditTF(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Vista_EditTF dialog = new Vista_EditTF(new javax.swing.JDialog(), true);
